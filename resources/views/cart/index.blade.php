            ...
            <div class="overflow-y-auto max-h-[85vh]">
                ...
                <div class="bg-white shadow rounded p-6">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="font-semibold">IDR {{ number_format($commands->sum(function($command) { return $command->match->price * $command->quantity; }), 0, ',', '.') }}</span>
                    </div>
                    <form action="{{route('transaction.create')}}" method="POST" class="mt-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <label class="text-sm" for="terms_check"> Saya setuju dengan syarat dan ketentuan</label>
                        </div>
                ...
                <div class="text-2xl font-semibold">
                    Belum ada pesanan di keranjang, ayo pesan sekarang <a href="{{route('matches.store')}}" class="text-blue-500">disini.</a>
                </div>
                @endif
            </div>
        </div>
