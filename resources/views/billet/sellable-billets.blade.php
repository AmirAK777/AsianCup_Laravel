            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 ">
                ...
                <div class="col-md-6 mb-5">
                    ...
                    <div class="bg-white overflow-hidden shadow rounded-lg border border-gray-700 border-solid" style=" background: linear-gradient(136deg, #1a2028 3.36%, rgba(26, 32, 40, 0.76) 97.71%);">
                            ...
                            <div class="border-gray-700 px-4 py-5 sm:p-0">
                                ...
                                <dl class="sm:divide-y divide-zinc-700">
                                    ...
                                    <dd class="mt-1 text-sm text-zinc-300 sm:mt-0 sm:col-span-2 flex justify-around items-center space-x-3">
                                        ...
                                        <form action="{{ route('billet.buy', ['id' => $billet->billet_id]) }}" method="POST">
                                            ...
                                            <x-secondary-button class="flex space-x-2 m-2" type="submit">
                                                <svg class="w-6 h-6 text-zinc-300	 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 4h1.5L9 16m0 0h8m-8 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4Zm8 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4Zm-8.5-3h9.25L19 7h-1M8 7h-.688M13 5v4m-2-2h4" />
                                                </svg>
                                                {{ __('Acheter') }}</x-secondary-button>
                                        </form>
                                    </dd>
